...
// Q: https://codeforces.com/contest/2035/problem/B
...
void solution() {
  ...
  std::string number;
  if (n % 2 == 0) {
    for (int i = 0; i < n - 2; ++i) number.push_back('3');
    number.push_back('6');
  }

  if (n % 2 != 0) {
    for (int i = 0; i < n - 5; ++i) number.push_back('3');
    number.push_back('3');
    number.push_back('6');
    number.push_back('3');
    number.push_back('6');
