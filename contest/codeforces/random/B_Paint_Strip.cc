...
// problem: https://codeforces.com/contest/2040/problem/B
...
std::uint64_t A002804(int n) {
  return static_cast<int>(std::pow(2, n)) + static_cast<int>(std::floor(std::pow(1.5, n))) - 2;
}
}  // namespace px
